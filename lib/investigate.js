...
export function analyzeChunk(text = '') {
  ...
  const activityPatterns = [
    /\b([A-Z][a-z]+\s+[A-Z][a-z]+)\s+(met|called|emailed|texted|requested|asked|sent|received|purchased|visited|signed|reviewed|approved|denied|mapped|shared|forwarded|transferred)\b/gi,
    /\b(met|called|emailed|texted|requested|asked|sent|received|purchased|visited|signed|reviewed|approved|denied|mapped|shared|forwarded|transferred)\b/gi
  ];
