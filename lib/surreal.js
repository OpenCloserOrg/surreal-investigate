...
export async function ensureSchema(db) {
  await db.query(`
    ...
    DEFINE TABLE IF NOT EXISTS intent SCHEMALESS;
    ...
    DEFINE INDEX IF NOT EXISTS activity_cache_idx ON TABLE activity COLUMNS cacheId;
    DEFINE INDEX IF NOT EXISTS intent_cache_idx ON TABLE intent COLUMNS cacheId;
